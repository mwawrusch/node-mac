                ...
                if (attributes.bodyhash ||
                    ...
                    if (hostHeader) {
                        ...
                        if (hostParts &&
                            ...
                            callback(false, credentials, 'Bad Host header');
                        }
                    }
                    else {

                        // Error: Missing Host header field
                        callback(false, credentials, 'Missing Host header');
                    }
                }
                else {

                    // Error: Missing body hash attribute
                    callback(false, credentials, 'Missing required body hash attribute');
                }
            }
            else {

                // Error: Missing authentication attribute
                callback(false, credentials, 'Missing attributes');
            }
        }
        else {

            // Error: Wrong authentication scheme
            callback(false, credentials, 'Incorrect authentication scheme');
        }
    }
    else {

        // Error: No authentication
        callback(false, credentials, 'No authentication');
    }
};
...
exports.WWWAuthenticateHeader = function (message) {
